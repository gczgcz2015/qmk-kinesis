...
def main() -> None:
    ...
    print(
        "layout validation passed: 84 wired keys, "
        "76 VIA/Vial-visible keys, 8 hidden, 4 synchronized layers"
    )
