...
def hardware_svg() -> str:
  ...
  <g transform="translate(60 2020)">
    ...
    <text class="hardware-text" x="1274" y="158">CPI 档位：100 / 200 / 300 / … / 1600（每档 100）</text>
    <text class="hardware-text" x="1274" y="184">　　　　　1700 / 1800 / 1900 / … / 3200</text>
    <text class="hardware-text" x="1274" y="210">CPI− / CPI+ 可在 Vial User 页分配，档位断电保存。</text>
    <text class="hardware-text" x="1274" y="236">Ogen 丝印 UP 朝键盘顶部；只输出光标 X/Y。</text>
